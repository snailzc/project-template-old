...
class UploadModal extends Component {
  ...
  handleUpload = () => {
    ...
    if (pageElement.excel_upload && pageElement.excel_upload.uri) {
      // You can use any AJAX library you like
      reqwest({
        url: `/api${pageElement.excel_upload.uri}`,
        method: 'post',
        headers: {
  ...
  downFile = () => {
    ...
    window.open(`/api${pageElement.down_example.uri}?fileName=${fileName}&token=${localStorage.getItem('user-token')}`, 'blank');
  }
  ...
  render() {
    ...
    const props = {
      action: pageElement.excel_upload ? pageElement.excel_upload.uri : '',
      onRemove: (file) => {
      ...
      show
        ...
        (
          ...
          >
            ...
            {
              pageElement && pageElement.down_example
              ?
                <div>
                  <Button
